...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
        ...
        <div class="rounded-xl border bg-white shadow-sm">
            <div class="px-6 py-6 sm:px-10">
                ...
                <form action="#" method="POST" class="mt-8 space-y-10">
                    ...
                    {{-- Section: Producent --}}
                    <div>
                        <h2 class="text-sm font-semibold text-slate-900">Producent</h2>

                        <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                            {{-- Producent --}}
                            <div>
                                <label class="text-sm font-medium text-slate-700">Producent</label>
                                <input
                                    type="text"
                                    name="producer_name"
    ...
    <input type="text" wire:model.defer="nombres" 
        class="mt-2 w-full rounded-lg border @error('nombres') border-red-500 @else border-slate-200 @enderror ...">
    ...
    @enderror
                            ...
                            {{-- Naam productiehuis --}}
                            <div>
                                <label class="text-sm font-medium text-slate-700">Naam productiehuis</label>
                                <input
                                    type="text"
                                    name="company_name"
                                    value="Cineville"
                            ...
                            {{-- Straatnaam --}}
                            <div>
                                <label class="text-sm font-medium text-slate-700">Straatnaam</label>
                                <input
                                    type="text"
                                    name="street"
                                    class="mt-2 w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900
                                           placeholder:text-slate-400 focus:border-violet-500 focus:ring-4 focus:ring-violet-100 outline-none"
                                    placeholder="Pieter van Heij straat"
                                />
                            </div>

                            {{-- Huisnummer --}}
                            <div>
                                <label class="text-sm font-medium text-slate-700">Huisnummer</label>
                                <input
                                    type="text"
                                    name="house_number"
                                    class="mt-2 w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900
                            ...
                            {{-- Telefoonnummer --}}
                            <div>
                                <label class="text-sm font-medium text-slate-700">Telefoonnummer</label>
                            ...
                            {{-- Postcode + Plaatsnaam --}}
                            <div>
                                <label class="text-sm font-medium text-slate-700">Postcode</label>
                    ...
                    {{-- Section: Logos --}}
                    <div>
                        <h2 class="text-sm font-semibold text-slate-900">Logo(s) productiehuis</h2>

                        {{-- Info alert --}}
                        <div class="mt-4 flex items-start gap-3 rounded-lg border border-sky-200 bg-sky-50 px-4 py-3">
                            <div class="mt-0.5 grid size-6 place-items-center rounded-full bg-sky-100 text-sky-700">
                            ...
                            <p class="text-sm text-sky-800">
                                Het is niet verplicht om een logo toe te voegen aan een productie.
                            </p>
                        </div>

                        {{-- Dropzone --}}
                        <div class="mt-5">
                            <label class="text-sm font-medium text-slate-700">Logo(s) uploaden</label>

                            <div class="mt-2 rounded-xl border-2 border-dashed border-violet-200 bg-violet-50/40 p-6">
                                <div class="flex flex-col items-center justify-center gap-3 text-center">
                                    <div class="grid size-11 place-items-center rounded-full bg-white shadow-sm">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="size-5 text-violet-600" viewBox="0 0 24 24" fill="currentColor">
                                    ...
                                    <div class="text-sm text-slate-600">
                                        <span class="font-medium text-violet-700">Sleep Afbeelding</span>
                                        <span>of</span>
                                        <label class="ml-1 inline-flex cursor-pointer items-center rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50">
                                            Bestand kiezen
                                            <input type="file" name="logos[]" class="hidden" multiple>
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        {{-- Uploaded file row (mock) --}}
                        <div class="mt-4 overflow-hidden rounded-lg border border-slate-200">
                            <div class="flex items-center gap-3 px-4 py-3">
                                <div class="grid size-10 place-items-center rounded-md bg-amber-100 text-amber-700 font-semibold text-xs">
                                    JPG
                                </div>

                                <div class="min-w-0 flex-1">
                                    <p class="truncate text-sm font-medium text-slate-900">flyfilm-logo-yellow.jpeg</p>
                                    <p class="text-xs text-slate-500">Uploaded</p>
                                </div>

                                <button type="button" class="inline-flex items-center justify-center rounded-md p-2 text-slate-500 hover:bg-slate-50 hover:text-rose-600">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="size-5" viewBox="0 0 24 24" fill="currentColor">
                                        <path d="M9 3a1 1 0 0 0-1 1v1H5a1 1 0 1 0 0 2h1v13a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V7h1a1 1 0 1 0 0-2h-3V4a1 1 0 0 0-1-1H9Zm1 2h4v0h-4v0ZM9 10a1 1 0 0 1 1 1v7a1 1 0 1 1-2 0v-7a1 1 0 0 1 1-1Zm6 0a1 1 0 0 1 1 1v7a1 1 0 1 1-2 0v-7a1 1 0 0 1 1-1Z"/>
                                    </svg>
                                </button>
                            </div>
                        </div>
